...
class UserController extends BaseController
{
     ...
     * @apiParam {int} perPage  数量
     * @apiSuccess (200) {String} email 邮箱
     * @apiSuccess (200) {String} name  名称
     * @apiSuccess (200) {String} avatar  头像
     * @apiSuccess (200) {String} created_at  创建时间
     * @apiSuccess (200) {String} updated_at  修改时间
     * @apiSuccess (200) {String} deleted_at  删除时间
